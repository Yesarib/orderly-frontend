                                    ...
                                    <div className="flex justify-between items-center ">
                                        <div className="flex gap-4">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <Typography className="font-inter"> {order.areaId} / {order.tableId} </Typography>
                                            </div>
                                        </div>
                                        <div className="">
                                            <Button className="flex gap-2 items-center border h-10 capitalize rounded-sm shadow-none bg-gray-200 text-gray-800" variant="filled">
                                                <Typography className="font-inter "> Tümü Hazır </Typography>
                                            </Button>
                                        </div>
                                    </div>
                                    <div className="mt-2">
                                        ...
                                        {order.items.map((item) => {
                                            ...
                                            return (
                                                <div className="flex items-center justify-between mt-2">
                                                    ...
                                                    <div className="mt-5">
                                                        <Button className="flex gap-2 items-center border h-10 capitalize rounded-sm shadow-none bg-gray-200 text-gray-800" variant="filled">
                                                            <Typography className="font-inter "> Hazır </Typography>
                                                        </Button>
                                                    </div>
                                                </div>
                                            )
